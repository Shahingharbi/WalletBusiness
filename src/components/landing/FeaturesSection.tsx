  ...
  return (
    <section className="bg-white py-20 lg:py-[86px]" id="features">
      <div className="mx-auto max-w-[1280px] px-6">
        ...
        >
          Tout ce qu&apos;il faut pour fideliser vos clients
        </h2>
        <p
          className="text-center text-base text-muted-foreground mt-4 max-w-2xl mx-auto"
          style={{ fontFamily: "var(--font-maison-neue)" }}
        >
          Une solution complete, pensee pour les commercants qui veulent des resultats
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col rounded-2xl border border-border overflow-hidden hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed flex-1" style={{ fontFamily: "var(--font-maison-neue)" }}>
                Envoyez promos, offres flash et rappels directement sur le telephone de vos clients.
                0 EUR par message, contre 0,05 EUR par SMS.
              </p>
            </div>
          </div>

          {/* Feature 2: Geolocalisation */}
          <div className="flex flex-col rounded-2xl border border-border overflow-hidden hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed flex-1" style={{ fontFamily: "var(--font-maison-neue)" }}>
                Vos clients recoivent une notification quand ils passent a proximite de votre commerce.
          ...
          <div className="flex flex-col rounded-2xl border border-border overflow-hidden hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed flex-1" style={{ fontFamily: "var(--font-maison-neue)" }}>
                Suivez en temps reel vos clients fidelises, le taux de retour et le nombre de scans par jour.
                Toutes les donnees pour piloter votre fidelisation.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col rounded-2xl border border-border overflow-hidden hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed flex-1" style={{ fontFamily: "var(--font-maison-neue)" }}>
                Logo, couleurs, regles de fidelite (tampons, points, cashback). Votre carte, votre identite.
                Vos clients vous reconnaissent instantanement.
              </p>
            </div>
          </div>

          {/* Feature 5: Compatible caisses */}
          <div className="flex flex-col rounded-2xl border border-border overflow-hidden hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="flex flex-col rounded-2xl border border-border overflow-hidden hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed flex-1" style={{ fontFamily: "var(--font-maison-neue)" }}>
                Inscription, personnalisation de la carte, impression du QR code.
                Vous etes operationnel le jour meme, sans connaissances techniques.
              </p>
            </div>
          </div>
        </div>
