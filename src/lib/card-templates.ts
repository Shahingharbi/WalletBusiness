...
export const CARD_TEMPLATES: CardTemplate[] = [
  make("kebab", "Kebab", "🥙", "stamp", "Carte fidélité kebab", "Un kebab offert !", 10,
  ...
  make("pizzeria", "Pizzeria", "🍕", "stamp", "Pizza fidélité", "Une pizza margherita offerte !", 8,
    "#fff1f2", "#1c1917", "#e11d48", "pizza", "circle",
    "1513104890138-7c749659a591"),
  make("cafe", "Café & salon de thé", "☕", "stamp", "Carte café", "Un café offert !", 9,
    "#f5f5f4", "#292524", "#92400e", "coffee", "circle",
    "1495474472287-4d71bcdd2085"),
  make("restaurant", "Restaurant", "🍽️", "stamp", "Carte fidélité", "10% sur l'addition !", 8,
    "#f0fdf4", "#14532d", "#16a34a", "star", "circle",
    "1414235077428-338989a2e8c0"),
  make("coiffeur", "Salon de coiffure", "💇", "stamp", "Salon fidélité", "Une coupe offerte !", 6,
    "#f5f3ff", "#1e1b4b", "#7c3aed", "scissors", "squircle", null),
  make("institut", "Institut de beauté", "💅", "stamp", "Carte beauté", "Un soin du visage offert !", 8,
    "#fdf2f8", "#831843", "#db2777", "flower", "circle",
    "1490750967868-88aa4486c946"),
  make("pressing", "Pressing", "👔", "stamp", "Pressing fidélité", "Un nettoyage offert !", 10,
    "#eff6ff", "#1e3a8a", "#2563eb", "sparkle", "squircle",
    "1489987707025-afc232f7ea0f"),
  make("fleuriste", "Fleuriste", "💐", "stamp", "Bouquet fidélité", "Un bouquet de saison offert !", 7,
  ...
  make("epicerie", "Épicerie / Primeur", "🥗", "cashback", "Carte cashback", "5% cashback sur chaque achat", 10,
    "#f7fee7", "#14532d", "#65a30d", "leaf", "circle",
    "1542838132-92c53300491e"),
  make("vip", "VIP / Membre Premium", "👑", "membership", "Adhésion Premium", "Accès aux ventes privées + 15%", 1,
  ...
  make("scratch", "Repartir de zéro", "✨", "stamp", "", "", 8,
